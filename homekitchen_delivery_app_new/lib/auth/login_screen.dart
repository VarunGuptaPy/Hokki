              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Let's get you back to your delivery plans. Please enter your login information.",
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: RichText(
                        text: TextSpan(
                          text:
                              'By clicking the “Login” button, you acceptthe terms of the ', // Non-Bold Text
                    ...
                    GestureDetector(
                      ...
                      child: RichText(
                        text: TextSpan(
                          text:
                              'Don\'t have an account? Create one ', // Non-Bold Text
                          style:
                              TextStyle(color: Color(0xffBDBDCF), fontSize: 16),
                          children: [
                            TextSpan(
                                text: 'here',
                                style: TextStyle(
